...
export default function IncidentManagement() {
  ...
  const pageLayouts = layouts['incident-management'] || {
    lg: [
  ...
  const handleLayoutChange = (currentLayout: any, allLayouts: any) => {
    updateLayout('incident-management', allLayouts);
  };

  const exportDashboard = async () => {
    const dashboard = document.getElementById('incident-management-dashboard');
    if (!dashboard) return;
    ...
    pdf.save('incident-management.pdf');
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="incident-management-dashboard">
        <GridLayoutWrapper
          layouts={pageLayouts}
